 ...
 */
@MappedSuperclass
public abstract class AbstractSourcedGeneratedObject extends AbstractValueObject implements SourcedGeneratedObject {
	@OneToMany
	...
	@Override
	public void updateGenerators(SourcedGeneratedObject objectSourced) {
